...
# Creating a security group named myapp_jenkins_sg
# Remember, this security group is for our Jenkins EC2 instance
resource "aws_security_group" "myapp_jenkins_sg" {
  # Name, Description and the VPC of the Security Group
  name = "myapp_jenkins_sg"
  ...
  # We are setting the Name tag to myapp_jenkins_sg
  tags = {
    Name = "myapp_jenkins_sg"
  }
}
